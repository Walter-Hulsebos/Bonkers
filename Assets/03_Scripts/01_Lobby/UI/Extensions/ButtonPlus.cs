...
namespace UnityEngine.UI
{
    ...
    /// </summary>
    [AddComponentMenu("UI/ButtonPlus", 30)]
    public class ButtonPlus : Selectable, IPointerClickHandler, ISubmitHandler
    {
        [Serializable]
        /// <summary>
        /// Function definition for a button click event.
        /// </summary>
        public class ButtonPlusClickedEvent : UnityEvent {}

        // Event delegates triggered on click.
        [FormerlySerializedAs("onClick")]
        [SerializeField]
        private ButtonPlusClickedEvent m_OnClick = new ButtonPlusClickedEvent();
        
        [SerializeField] private UnityEvent onHighlightStart;
        [SerializeField] private UnityEvent onHighlightEnd;
        
        [SerializeField] private UnityEvent onSelectedStart;
        [SerializeField] private UnityEvent onSelectedEnd;
        ...
        ///</code>
        ///</example>
        public ButtonPlusClickedEvent onClick
        {
