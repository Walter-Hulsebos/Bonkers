...
//     {
//         protected static SelectablePlus[] s_Selectables     = new SelectablePlus[10];
...
//         ///</code>
//         /// </example>
//         public static SelectablePlus[] allSelectablesArray
//         {
//             get
//             {
//                 SelectablePlus[] temp = new SelectablePlus[s_SelectableCount];
...
//         public static List<SelectablePlus> allSelectables
//         {
//             get
//             {
//                 return new List<SelectablePlus>(allSelectablesArray);
//             }
//         }
//
//
...
//         ///</code>
//         /// </example>
//         public static int AllSelectablesNoAlloc(SelectablePlus[] selectables)
//         {
...
//             {
//                 SelectablePlus[] temp = new SelectablePlus[s_Selectables.Length * 2];
...
//         ///</code>
//         /// </example>
//         public SelectablePlus FindSelectable(Vector3 dir)
//         {
//             dir = dir.normalized;
...
//
//             SelectablePlus bestPick         = null;
//             SelectablePlus bestFurthestPick = null;
//
//             for (int i = 0; i < s_SelectableCount; ++i)
//             {
//                 SelectablePlus sel = s_Selectables[i];
//
//                 if (sel == this)
//                     continue;
//
...
//         void Navigate(AxisEventData eventData, SelectablePlus sel)
//         {
...
//         ///</code>
//         /// </example>
//         public virtual SelectablePlus FindSelectableOnLeft()
//         {
...
//         ///</code>
//         /// </example>
//         public virtual SelectablePlus FindSelectableOnRight()
//         {
//             if (m_Navigation.mode == Navigation.Mode.Explicit)
//             {
...
//         ///</code>
//         /// </example>
//         public virtual SelectablePlus FindSelectableOnUp()
//         {
//             if (m_Navigation.mode == Navigation.Mode.Explicit)
//             {
...
//         ///</code>
//         /// </example>
//         public virtual SelectablePlus FindSelectableOnDown()
//         {
//             if (m_Navigation.mode == Navigation.Mode.Explicit)
//             {
