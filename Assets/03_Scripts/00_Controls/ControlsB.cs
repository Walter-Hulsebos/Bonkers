...
//     version 1.7.0
//     from Assets/03_Scripts/00_Controls/ControlsB.inputactions
//
...
{
    public partial class @ControlsB: IInputActionCollection2, IDisposable
    {
    ...
    ""controlSchemes"": [
        ...
        {
            private @ControlsB m_Wrapper;
            public GameplayActions(@ControlsB wrapper) { m_Wrapper = wrapper; }
