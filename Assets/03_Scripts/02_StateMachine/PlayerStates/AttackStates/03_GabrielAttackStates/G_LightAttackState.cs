...
public sealed class G_LightAttackState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public G_LightAttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    #endregion
