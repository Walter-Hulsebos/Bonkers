...
public sealed class G_HeavyAttackState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public G_HeavyAttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    #endregion
