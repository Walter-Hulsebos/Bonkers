...
public sealed class G_S1AttackState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public G_S1AttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    ...
    public override void EnterState()
    {
        ...
        HandleGabrielSpecial1();
    }

    public override void ExitState() { }

    void HandleGabrielSpecial1()
    {
