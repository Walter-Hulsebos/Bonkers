...
[Serializable]
public sealed class G_S2AttackState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public G_S2AttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    ...
    public override void EnterState()
    {
        ...
        HandleGabrielSpecial2();
    }

    public override void ExitState() { }

    void HandleGabrielSpecial2()
    {
