...
public sealed class D_HeavyAttackState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public D_HeavyAttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    #endregion
