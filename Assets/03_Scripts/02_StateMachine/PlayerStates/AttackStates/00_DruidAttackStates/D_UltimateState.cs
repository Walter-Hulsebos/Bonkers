...
public sealed class D_UltimateState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public D_UltimateState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    #endregion
