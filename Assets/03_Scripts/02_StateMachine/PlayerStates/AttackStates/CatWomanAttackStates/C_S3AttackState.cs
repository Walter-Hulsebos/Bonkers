...
[Serializable]
public sealed class C_S3AttackState : PlayerBaseState
{
    #region Enums
    ...
    #region Constructor
    public C_S3AttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    ...
    public override void EnterState()
    {
        ...
        HandleCatWomanSpecial3();
    }

    public override void ExitState() {}

    void HandleCatWomanSpecial3()
    {
