...
public sealed class S_HeavyAttackState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public S_HeavyAttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    #endregion
