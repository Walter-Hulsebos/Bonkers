...
public sealed class S_LightAttackState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public S_LightAttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    #endregion
