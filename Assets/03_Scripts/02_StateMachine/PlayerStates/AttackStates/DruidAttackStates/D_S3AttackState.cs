...
[Serializable]
public sealed class D_S3AttackState : PlayerBaseState
{
    #region Enums
    ...
    #region Constructor
    public D_S3AttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
