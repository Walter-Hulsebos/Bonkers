...
public sealed class R_S1AttackState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public R_S1AttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    ...
    public override void EnterState()
    {
        ...
        HandleRobertoSpecial1();
    }

    public override void ExitState() { }

    void HandleRobertoSpecial1()
    {
