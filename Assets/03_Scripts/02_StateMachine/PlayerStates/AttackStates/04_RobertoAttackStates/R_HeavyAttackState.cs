...
public sealed class R_HeavyAttackState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public R_HeavyAttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    #endregion
