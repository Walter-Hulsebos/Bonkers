...
public sealed class R_LightAttackState : PlayerBaseState
    {
        #region Enums
        ...
        #region Constructor
        public R_LightAttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
        #endregion
