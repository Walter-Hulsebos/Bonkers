...
public sealed class R_UltimateState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public R_UltimateState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    #endregion
