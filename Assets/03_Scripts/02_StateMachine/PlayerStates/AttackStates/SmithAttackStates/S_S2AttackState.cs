...
[Serializable]
public sealed class S_S2AttackState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public S_S2AttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
