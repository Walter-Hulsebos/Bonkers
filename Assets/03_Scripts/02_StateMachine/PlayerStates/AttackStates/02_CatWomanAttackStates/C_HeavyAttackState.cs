...
public sealed class C_HeavyAttackState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public C_HeavyAttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    #endregion
    ...
    void HandleCatWomanHeavyAttack()
    {
