...
using Unity.VisualScripting;
    ...
    public sealed class C_LightAttackState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public C_LightAttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    #endregion
