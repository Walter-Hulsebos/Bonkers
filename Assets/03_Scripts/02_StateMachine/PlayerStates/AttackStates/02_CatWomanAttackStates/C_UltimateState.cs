...
public sealed class C_UltimateState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public C_UltimateState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    #endregion
