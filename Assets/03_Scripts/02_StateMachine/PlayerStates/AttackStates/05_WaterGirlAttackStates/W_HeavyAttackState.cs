...
public sealed class W_HeavyAttackState : PlayerBaseState
    {
    #region Enums
    private InHeavyAttack inHeavy;
    #endregion

    #region Constructor
    public W_HeavyAttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    #endregion
    ...
    public override void EnterState()
    {
        ...
        Ctx.Anims.SetTrigger(Ctx.HeavyAttackHash);
        HandleWaterGirlHeavyAttack();
    ...
    void HandleWaterGirlHeavyAttack()
    {
        inHeavy = InHeavyAttack.Heavy;
