...
[Serializable]
public sealed class W_S2AttackState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public W_S2AttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    ...
    public override void EnterState()
    {
        ...
        HandleWaterGirlSpecial2();
    }

    public override void ExitState() { }

    void HandleWaterGirlSpecial2()
    {
