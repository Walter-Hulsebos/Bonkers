...
public sealed class W_UltimateState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public W_UltimateState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    #endregion
