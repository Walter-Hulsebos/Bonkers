...
[Serializable]
public sealed class W_S1AttackState : PlayerBaseState
    {
    #region Enums
    ...
    #region Constructor
    public W_S1AttackState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory) { }
    ...
    public override void EnterState()
    {
        ...
        HandleWaterGirlSpecial1();
    }

    public override void ExitState() { }

    void HandleWaterGirlSpecial1()
    {
