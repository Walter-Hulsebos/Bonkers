...
{
    public class PlayerExtraJumpState : PlayerBaseState
    {


        #region Variables

        [SerializeField] private F32 maxJumpHeight = 3.0f;
        ...
        public PlayerExtraJumpState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory)
        {
            IsRootState = true;
