...
[Serializable]
public sealed class DoubleJumpState : PlayerBaseState
{
    ...
    public DoubleJumpState(PlayerStateMachine currentContext, PlayerStateFactory playerStateFactory) : base(currentContext, playerStateFactory)
    {
        IsRootState = true;
    }
