...
namespace UltEvents.Editor
{
    ...
    internal sealed class ObjectPickerWindow : EditorWindow
    {
        ...
        private static class InternalGUI
        {
            ...
            static InternalGUI()
            {
                SearchBarStyle       = EditorStyles.toolbarSearchField; // GUI.skin.FindStyle("ToolbarSeachTextField");
                SearchBarEndStyle    = EditorStyles.toolbarButton;      // GUI.skin.FindStyle("ToolbarSeachCancelButtonEmpty");
                SearchBarCancelStyle = EditorStyles.toolbarButton;      // GUI.skin.FindStyle("ToolbarSeachCancelButton");
